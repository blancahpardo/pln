...
function buildInteractiveManualView(viewKey, tema) {
  ...
  // with more than one interactive manual (e.g. 'inicio', with a separate
...
const TEMAS = [
  { dir: 'inicio', numLabel: 'INICIO', titleShort: 'Inicio', titleFull: 'Inicio', kicker: 'Inicio',
    viewOrder: ['vscode_interactivo', 'ipynb_interactivo', 'adicionales'],
    views: {
      vscode: { exists: true, file: 'entornos_python_vscode.pdf' },
      vscode_interactivo: { exists: true, kind: 'interactive_manual', label: 'Entornos de Python y VS Code', icon: '💻',
        desc: 'Manual interactivo, navegable por paneles', dataFile: 'vscode_manual_interactivo.json', pdfViewKey: 'vscode' },
      ipynb: { exists: true, file: 'trabajar_con_ipynb.pdf' },
      ipynb_interactivo: { exists: true, kind: 'interactive_manual', label: 'Trabajar con ficheros .ipynb', icon: '📓',
        desc: 'Manual interactivo, navegable por paneles', dataFile: 'ipynb_manual_interactivo.json', pdfViewKey: 'ipynb' },
  ...
  { dir: 't0a', numLabel: 'TEMA 0', titleShort: 'Recordatorio', titleFull: 'Tema 0 · Recordatorio de Python', kicker: 'Tema 0 · Recordatorio',
    viewOrder: ['manual_interactivo','linguaistica_python','adicionales','principal','evaluable','practica','quiz'],
    views: {
      ...
      linguaistica_python: { exists: true, kind: 'image', label: 'Python para lingüistas aterrorizados (LinguAIstica)', icon: '🖼️',
        desc: 'Infografía: seis conceptos fundamentales de Python para empezar a automatizar análisis lingüísticos', file: 'linguaistica_python.jpeg',
        captionHtml: 'linguAIstica. (2026, julio). <em>¿De verdad hace falta aprender «mucho Python» para empezar a automatizar análisis lingüísticos?</em> [Publicación con infografía adjunta]. LinkedIn. <a href="https://www.linkedin.com/posts/linguaistica_linguaistica-python-computationallinguistics-activity-7488209541248118784-8qn8/" target="_blank" rel="noopener">https://www.linkedin.com/posts/linguaistica_linguaistica-python-computationallinguistics-activity-7488209541248118784-8qn8/</a>' },
      adicionales: { exists: true, kind: 'reflist', label: 'Conocimientos adicionales', icon: '🔗',
        desc: 'Recursos externos recomendados (LinguAIstica)', refs: [
    ...
    views: {
      ...
      adicionales: { exists: true, kind: 'reflist', label: 'Conocimientos adicionales', icon: '🔗',
        desc: 'Recursos externos recomendados (LinguAIstica)', refs: [
          ...
          { author: 'linguAIstica', date: '2026, 10 de septiembre', title: 'La palabra que aparece 10.000 veces y es inútil para un LLM', type: 'Vídeo', platform: 'YouTube', url: 'https://www.youtube.com/shorts/BciMr5FHeOg' },
          { author: 'linguAIstica', date: '2026, 12 de septiembre', title: 'Representación textual clásica: bag-of-words, n-gramas y TF-IDF', type: 'Infografía', platform: 'LinkedIn', url: 'https://www.linkedin.com/feed/update/urn:li:activity:7504116614728933377/', img: 'linguaistica_infografia_representacion_textual.jpg' },
          { author: 'linguAIstica', date: '2026, 16 de septiembre', title: 'Análisis de sentimiento con Python: tu primer proyecto de NLP', type: 'Vídeo', platform: 'YouTube', url: 'https://www.youtube.com/watch?v=JTQgOk604t8' },
          { author: 'linguAIstica', date: '2026, 17 de septiembre', title: 'Los límites de un modelo básico de análisis de sentimiento: ironía, negación y contexto', type: 'Carrusel de fotos', platform: 'Instagram', url: 'https://www.instagram.com/linguaistica/p/DdZSEgAjbCh/' },
          { author: 'linguAIstica', date: '2026, 19 de septiembre', title: '«Qué bien»... ¿significa que todo está bien?', type: 'Vídeo', platform: 'YouTube', url: 'https://www.youtube.com/shorts/ehDtD14PQns' },
        ] },
      infografia: { exists: true, kind: 'image', label: 'Infografía', icon: '🖼️',
        desc: 'Resumen visual del tema, en imagen grande', file: 'infografia.png' },
      principal: { exists: true, file: 'cuaderno_principal.ipynb' },
