...
SRC = '/Users/blanca/Library/CloudStorage/OneDrive-UniversidadPontificiaComillas/2. Trabajo/4. UPComillas/1. Docencia UPCO/21. Programación para PLN/0.0 Instalaciones iniciales/0. Trabajar con ficheros .ipynb.docx'
OUT = '/tmp/pln-interactive/inicio/ipynb_manual_interactivo.json'
...
NAV_TITLES = {
    'Título narrativo': 'Del fichero al cuaderno',
    'Contexto profesional': 'Contexto profesional',
    'Encargo': 'Encargo',
    'Caso de trabajo inicial': 'Caso de trabajo',
    'Qué vas a aprender en esta unidad': 'Qué vas a aprender',
    'Mapa conceptual de la unidad': 'Mapa conceptual',
    '1. Marco teórico: comprender el fichero `.ipynb`': 'Marco teórico',
    '2. Abrir un fichero `.ipynb` en Google Colab': 'Abrir en Google Colab',
    '3. Abrir un fichero .ipynb en Visual Studio Code': 'Abrir en VS Code',
    '4. Comparación del flujo completo': 'Comparación de flujos',
...
# row-1 header tuple).
TABLE_TITLES = {
    ('Mapa conceptual de la unidad', ('Punto de decisión', 'Google Colab', 'Visual Studio Code')): 'Mapa de decisión: Colab o VS Code',
    ('1.3. Abrir, confiar, ejecutar y guardar', ('Acción', 'Significado')): 'Acciones al abrir un cuaderno',
    ('4. Comparación del flujo completo', ('Momento', 'Google Colab', 'Visual Studio Code')): 'Comparación completa del flujo',
}
for sec in sections:
...
REF_KEYS = [
    ('google_colab_faq', 'Google. (s. f.). Google Colaboratory'),
    ('ms_jupyter_vscode', 'Microsoft. (s. f.). Jupyter Notebooks in Visual Studio Code'),
    ('ms_kernels_vscode', 'Microsoft. (s. f.). Manage Jupyter Kernels in Visual Studio Code'),
    ('jupyter_notebook', 'Project Jupyter. (s. f.). The Jupyter Notebook'),
]
refs_out = []
...
ITALIC_SPANS = {
    'google_colab_faq': 'Google Colaboratory: preguntas frecuentes',
    'ms_jupyter_vscode': 'Visual Studio Code Documentation',
    'ms_kernels_vscode': 'Visual Studio Code Documentation',
    'jupyter_notebook': 'The Jupyter Notebook',
}
for r in refs_out:
